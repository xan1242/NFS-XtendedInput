...
const char* ControlsTextsXBOX[] = { "A", "B", "X", "Y", "LB", "RB", "View (Select)", "Menu (Start)", "Left stick", "Right stick", "D-pad Up", "D-pad Down", "D-pad Left", "D-pad Right", "Right stick X", "Right stick Y", "Right stick Left", "Right stick Right" ,"Right stick Up", "Right stick Down", "Left stick X", "Left stick Y", "Left stick Left", "Left stick Right", "Left stick Up", "Left stick Down", "LT", "RT" };
const char* ControlsTextsPS[] = { "Cross", "Circle", "Square", "Triangle", "L1", "R1", "Share", "Options", "L3", "R3", "D-pad Up", "D-pad Down", "D-pad Left", "D-pad Right", "Right stick X", "Right stick Y", "Right stick Left", "Right stick Right" ,"Right stick Up", "Right stick Down", "Left stick X", "Left stick Y", "Left stick Left", "Left stick Right", "Left stick Up", "Left stick Down", "L2", "R2" };
const char* ControlsTextsPS3[] = { "Cross", "Circle", "Square", "Triangle", "L1", "R1", "Select", "Start", "L3", "R3", "D-pad Up", "D-pad Down", "D-pad Left", "D-pad Right", "Right stick X", "Right stick Y", "Right stick Left", "Right stick Right" ,"Right stick Up", "Right stick Down", "Left stick X", "Left stick Y", "Left stick Left", "Left stick Right", "Left stick Up", "Left stick Down", "L2", "R2" };
const char* ControlsTextsNSW[] = { "B", "A", "Y", "X", "L", "R", "Select (-)", "Start (+)", "Left stick", "Right stick", "D-pad Up", "D-pad Down", "D-pad Left", "D-pad Right", "Right stick X", "Right stick Y", "Right stick Left", "Right stick Right" ,"Right stick Up", "Right stick Down", "Left stick X", "Left stick Y", "Left stick Left", "Left stick Right", "Left stick Up", "Left stick Down", "ZL", "ZR" };

const char* ControlsTextsPC[] = {
unboundstr,
"Left Mouse Button",
"Right Mouse Button",
"Break",
...
vector<ActionID> PCRemapActionList = {
GAMEACTION_GAS,
GAMEACTION_BRAKE,
